<?php 
// koneksi ke database
$conn = mysqli_connect("localhost", "root", "", "bouquet");
...
function tambah($data) {
	...
	$username_seller = htmlspecialchars($data["username_seller"]);
	...
	mysqli_query($conn, "INSERT INTO produk VALUES(NULL, '$kode', '$username_seller', '$gambar', '$tgl_produksi', '$nama', '$deskripsi', '$harga', '$status')");
